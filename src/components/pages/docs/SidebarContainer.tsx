...
export function DesktopSidebar({
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="sticky top-18 hidden shrink-0 self-start rounded-lg border border-border bg-card p-2 text-muted-foreground shadow-sm transition-colors hover:text-brand lg:block cursor-pointer"
  ...
  return (
    <aside className="sticky top-18 hidden h-[calc(100vh-6rem)] w-64 shrink-0 self-start overflow-hidden rounded-2xl border border-border bg-muted/70 shadow-sm lg:block">
