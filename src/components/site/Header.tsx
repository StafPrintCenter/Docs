...
interface HeaderProps {
  /** Variant d'affichage selon le contexte de la page */
  variant?: HeaderVariant;
  /** Titre personnalisé à côté du logo (ex: "STAF Docs", "Centre d'aide") */
  title?: string;
  /** Sous-titre sous le titre principal (désactivé sur support-detail par défaut) */
  subtitle?: string;
  /** Largeur max de la grille (ex: "max-w-6xl", "max-w-5xl", "max-w-3xl", "max-w-[1600px]") */
  maxWidthClass?: string;
  /** Espace actif pour la navigation dans la doc */
  activeSpaceId?: string;
  /** Rendu sticky avec backdrop blur */
  sticky?: boolean;
  /** Callbacks d'actions */
  onOpenSearch?: () => void;
